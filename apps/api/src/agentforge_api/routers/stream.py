...
from agentforge_shared.events import serialise
from agentforge_shared.models import Agent, Event, Project
...
def _serialise(event: Event) -> dict:
    """Same representation as webhook payloads — one wire format, everywhere."""
